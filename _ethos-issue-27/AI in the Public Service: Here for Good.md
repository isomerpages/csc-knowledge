...
<em><small>ETHOS 27, July 2024</small></em>
...
<p>AI is but one tool, and a foretaste of things to come in the larger digital and technological space. The fundamental shift in our NAIS 2.0, and in our Smart Nation thinking, is that this is no longer just about reaping digitalisation opportunities—we are already in a digital world. The question is: how do we, as a society, live with the digital? How can we make it digitalisation something that benefits us, that helps us grow, but also something that is trusted and allows us to preserve our cohesion and values as one people? How can we use technology as a force for good—that takes us forward and brings people together? </p>

<div class="break">
<p class="break1"> The question is: how do we, as a society, live with digital? How can we use technology as a force for good—that takes us forward and brings people together?</p>
</div>

<p>Government must of course be proactive here. But there is no ready playbook. Leading nations and governments are learning by doing. If we are to succeed in this fast-moving, dynamic and often uncertain space, the Public Service will need to work in a more agile working culture. We must cultivate experimental and pioneering mindsets—be prepared to start small, fail so that we discover and learn, iterate to try again, and build and progress repeatedly this way. Most of us are not used to working this way, but this is a space where we often cannot define solutions upfront. We can only know and progress if we try. If we can do this at scale, the potential is enormous. </p>

<p>At its essence, the task ahead is to learn. We are all still learning and must learn relentlessly.</p>
